...
public class GuavaTester {
	   public static void main(String args[]) {
	      ...
	      employeeCache.put("103", new Employee("Rohan", "IT", "103"));
	      employeeCache.put("104", new Employee("Rohan", "IT", "104"));
	       System.out.println("size"+employeeCache.size());
	      try {			
	         //on first invocation, cache will be populated with corresponding
	         //employee record
	    	  employeeCache.invalidate("100");
	    	  employeeCache.invalidate("103");
	       ...
	       //  System.out.println(employeeCache.get("110"));
	         ...
	         /***System.out.println(employeeCache.get("103"));
	         System.out.println(employeeCache.get("110"));
	         System.out.println(employeeCache.get("104"));
	         **/
	         System.out.println("size"+employeeCache.size());
	        //employeeCache.invalidate("103");
	         System.out.println("size nbnbn"+employeeCache.size());
