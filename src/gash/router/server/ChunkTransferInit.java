...
public class ChunkTransferInit extends ChannelInitializer<SocketChannel> {
	boolean compress = false;
	ServerState state;

	public ChunkTransferInit(ServerState state, boolean enableCompression) {
		super();
	...
	public void initChannel(SocketChannel ch) throws Exception {
		...
		pipeline.addLast("handler", new ChunkTransferHandler(state));
	}
}